...
var PathPrompt = function (_BasePrompt) {
  ...
  function PathPrompt(question, rl, answers) {
    ...
    _this.paths = [];
    _this.autocomplete = new _PathAutocomplete2.default(question.cwd || question.default || process.cwd(), question.directoryOnly, question.caseSensitive);
    _this.renderer = new _PathPromptRenderer2.default(_this.rl, _this.screen, _this.autocomplete, _this.opt.message, _this.opt.promptPrefix);
    ...
    value: function submitAnswer() {
      ...
      if (!this.opt.multi) {
        ...
        promiseChain = promiseChain.then(function (finalAnswer) {
          ...
          _this2.autocomplete = new _PathAutocomplete2.default(_this2.autocomplete.getWorkingDirectory().getAbsolutePath(), _this2.autocomplete.isDirectoryOnly(), _this2.autocomplete.isCaseSensitive());
